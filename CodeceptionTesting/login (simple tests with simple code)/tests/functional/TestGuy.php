...
class TestGuy extends \Codeception\AbstractGuy
{
    ...
    * Conditional Assertion: Test won't be stopped on fail
     ...
     *
    * Conditional Assertion: Test won't be stopped on fail
     * @see Codeception\Module\TestHelper::seeClassExist()
     * @return \Codeception\Maybe
     */
    public function canSeeClassExist($class) {
        $this->scenario->addStep(new \Codeception\Step\ConditionalAssertion('seeClassExist', func_get_args()));
        if ($this->scenario->running()) {
            $result = $this->scenario->runStep();
            return new Maybe($result);
        }
    ...
    public function seeClassExist($class) {
        $this->scenario->addStep(new \Codeception\Step\Assertion('seeClassExist', func_get_args()));
        if ($this->scenario->running()) {
            $result = $this->scenario->runStep();
            return new Maybe($result);
        }
